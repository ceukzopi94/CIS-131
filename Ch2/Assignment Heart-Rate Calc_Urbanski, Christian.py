...
def main(): 
    #put code here
    user_age = get_integer("Enter your age: ")

    max_heart_rate = 220 - user_age
    min_target_heart_rate = max_heart_rate * .5
    max_target_heart_rate = max_heart_rate * .85

    print('Age:', user_age)
    print('Max Heart Rate:', max_heart_rate)
    print('Target Heart Rate:', min_target_heart_rate, '-',max_target_heart_rate)
