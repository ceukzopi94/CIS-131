...
root.iconbitmap('D:\Pima\CIS 131\TKinter\images collection\mario.ico')

my_img1 = ImageTk.PhotoImage(Image.open(
    "D:\Pima\CIS 131\TKinter\images collection\cool glasses.png"))
my_img2 = ImageTk.PhotoImage(Image.open(
    "D:\Pima\CIS 131\TKinter\images collection\butterfly.jpg"))
my_img3 = ImageTk.PhotoImage(Image.open(
    "D:\Pima\CIS 131\TKinter\images collection\spongebob.png"))
my_img4 = ImageTk.PhotoImage(Image.open("D:\Pima\CIS 131\TKinter\images collection\unifrog.png"))
my_img5 = ImageTk.PhotoImage(Image.open(
    "D:\Pima\CIS 131\TKinter\images collection\world outline.png"))
