...
def main(): 
    #put code here
    temp_str = get_string('What is your problem?')
    
    is_reoccuring = get_yes_or_no('Have you had these symptoms before?')

    if(is_reoccuring):
        print('Well, you will have them again. (yes or no)')
    else:
        print('Well,you have them now.')
