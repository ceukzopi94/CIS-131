...
def main(): 
    ...
    num_1 = get_valid_int("Please enter your first integer value of 1 or 2: ")
    num_2 = get_valid_int("Please enter your second integer value of 1 or 2: ")
...
def get_valid_int(msg):
    ...
    while is_invalid_int(num):
        #error message printed in in_invlaid_int funtion
        global counter
        counter += 1
