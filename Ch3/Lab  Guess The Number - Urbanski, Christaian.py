...
def main(): 
    ...
    user_num = get_integer(f'Enter a number between {MIN_NUM} and {MAX_NUM}: ')
    ...
    while user_num != rand_num:
        ...
        guess_count += 1
        user_num = get_integer(f'\nEnter a number between {MIN_NUM} and {MAX_NUM}: ')

    print(f'Congratulations!!! You guessed the correct number in {guess_count} times!')
